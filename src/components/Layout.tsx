...
import { Briefcase, Users, FileText, PlusCircle, LogOut, LayoutDashboard, Menu } from 'lucide-react'
              ...
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="relative h-10 w-10 rounded-full">
                  <Avatar className="h-10 w-10 border border-primary/20">
                    <AvatarImage src="https://img.usecurling.com/ppl/thumbnail?gender=female&seed=1" alt="Recrutador" />
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                <DropdownMenuLabel className="font-normal">
                  <div className="flex flex-col space-y-1">
                    <p className="text-sm font-medium leading-none">Roberta Costa</p>
  ...
  return (
    <Sidebar className="border-r border-primary/10">
      <SidebarHeader className="flex h-16 items-center px-4">
        <Link to="/vagas" className="flex items-center gap-2 font-bold text-xl text-secondary">
                  ...
                  <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton 
                      ...
                      className={cn(
                        ...
                        isActive ? "bg-primary/10 text-primary font-medium" : "text-muted-foreground hover:bg-muted hover:text-primary"
                      )}
                    >
                      <Link to={item.url}>
      ...
      <SidebarFooter className="p-4">
        <Button className="w-full bg-gradient-primary text-white shadow-md hover:shadow-lg tap-effect border-none" size="lg">
